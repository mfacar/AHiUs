...
class ModelGraphs:
    ...
    def plot_acc(history, title="Model Accuracy"):
        ...
        plt.plot(history.histosry['val_dense_6_acc'])
    ...
    @staticmethod
    def plot_acc3(history, title="Model Accuracy", num="1"):
        """Imprime una gráfica mostrando la accuracy por epoch obtenida en un entrenamiento"""
        plt.plot(history.history['dense_'+str(num)+'_acc'])
        plt.plot(history.history['val_dense_'+str(num)+'_acc'])
        plt.title(title)
        plt.ylabel('Accuracy')
        plt.xlabel('Epoch')
        plt.legend(['Train', 'Val'], loc='upper left')
    ...
    @staticmethod
    def plot_loss3(history, title="Model Loss", num="1"):
        """Imprime una gráfica mostrando la pérdida por epoch obtenida en un entrenamiento"""
        plt.plot(history.history['dense_'+str(num)+'_loss'])
        plt.plot(history.history['val_dense_'+str(num)+'_loss'])
        plt.title(title)
        plt.ylabel('Loss')
        plt.xlabel('Epoch')
    ...
    @staticmethod
    def plot_acc1(history, title="Model Accuracy"):
        """Imprime una gráfica mostrando la accuracy por epoch obtenida en un entrenamiento"""
